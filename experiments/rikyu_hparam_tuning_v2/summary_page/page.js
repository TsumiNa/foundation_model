...
(function(){
const ROWS = [["material_type", 33556, 0.571, 0.6988, 22.4, "*", 0.7245, 26.9, "*", 0.696, 21.9, "*", -3.9, "*", "macro_f1", 0.6698, 17.3, "*", 0.6939, 21.5, "*"], ["density", 23678, 0.9898, 0.9786, -1.1, "*", 0.9812, -0.9, "·", 0.9893, -0.1, "·", 0.8, "·", "r2", 0.98, -1.0, "·", 0.9888, -0.1, "·"], ["final_energy", 23678, 0.7739, 0.5904, -23.7, "*", 0.6042, -21.9, "*", 0.7033, -9.1, "*", 16.4, "*", "r2", 0.545, -29.6, "*", 0.6946, -10.2, "*"], ["total_magnetization", 23678, 0.7183, 0.665, -7.4, "*", 0.6606, -8.0, "*", 0.7049, -1.9, "", 6.7, "*", "r2", 0.6256, -12.9, "*", 0.7235, 0.7, ""], ["volume", 23678, 0.6191, 0.5192, -16.1, "*", 0.5166, -16.6, "*", 0.5767, -6.9, "*", 11.6, "*", "r2", 0.5083, -17.9, "*", 0.5789, -6.5, "*"], ["efermi", 23668, 0.9073, 0.895, -1.4, "*", 0.8941, -1.4, "*", 0.903, -0.5, "·", 1.0, "·", "r2", 0.8904, -1.9, "*", 0.901, -0.7, "·"], ["formation_energy", 23180, 0.9947, 0.9812, -1.4, "*", 0.9845, -1.0, "*", 0.9945, -0.0, "", 1.0, "*", "r2", 0.9811, -1.4, "*", 0.9947, -0.0, ""], ["seebeck", 8072, 0.7133, 0.6805, -3.6, "*", 0.7054, -1.1, "", 0.715, 0.2, "", 1.4, "", "r2", 0.6905, -3.2, "", 0.6923, -2.9, "*"], ["tc", 7207, 0.8153, 0.8021, -1.6, "*", 0.7999, -1.9, "*", 0.8117, -0.4, "", 1.5, "*", "r2", 0.7936, -2.7, "*", 0.8051, -1.2, ""], ["dos_density", 7009, 0.625, 0.5689, -9.0, "*", 0.5732, -8.3, "*", 0.5988, -4.2, "*", 4.5, "*", "r2", 0.5826, -6.8, "*", 0.6166, -1.3, "·"], ["curie", 6272, 0.8027, 0.7581, -5.6, "*", 0.7676, -4.4, "*", 0.7906, -1.5, "", 3.0, "*", "r2", 0.7681, -4.3, "*", 0.7966, -0.7, ""], ["electrical_resistivity", 5051, 0.1767, 0.1738, -1.6, "", 0.1919, 8.6, "*", 0.1877, 6.2, "", -2.2, "", "r2", 0.1799, 1.8, "", 0.187, 5.8, ""], ["thermal_conductivity", 4272, 0.7194, 0.6993, -2.8, "*", 0.7197, 0.0, "", 0.7187, -0.1, "", -0.1, "", "r2", 0.7155, -0.5, "", 0.7123, -1.0, ""], ["kp", 3875, 0.6957, 0.6762, -2.8, "*", 0.691, -0.7, "", 0.6858, -1.4, "", -0.8, "", "r2", 0.6836, -1.7, "", 0.6955, -0.0, ""], ["klat", 3863, 0.722, 0.7223, 0.0, "", 0.7123, -1.3, "", 0.7155, -0.9, "", 0.4, "", "r2", 0.7276, 0.8, "", 0.7387, 2.3, ""], ["power_factor", 3638, 0.6941, 0.6775, -2.3, "*", 0.7134, 2.8, "*", 0.7049, 1.5, "", -1.2, "", "r2", 0.7014, 1.0, "", 0.7, 0.8, ""], ["neel", 3466, 0.7176, 0.6959, -3.0, "*", 0.6925, -3.5, "*", 0.7244, 0.9, "", 4.6, "*", "r2", 0.682, -5.0, "*", 0.7303, 1.8, ""], ["zt", 3445, 0.66, 0.6809, 3.2, "", 0.7031, 6.5, "*", 0.7045, 6.7, "*", 0.2, "", "r2", 0.6876, 4.2, "", 0.6839, 3.6, ""], ["dielectric_total", 3124, 0.6587, 0.6369, -3.3, "*", 0.6525, -0.9, "", 0.6808, 3.4, "*", 4.3, "*", "r2", 0.6563, -0.4, "", 0.67, 1.7, ""], ["dielectric_ionic", 3124, 0.591, 0.5668, -4.1, "*", 0.568, -3.9, "*", 0.6076, 2.8, "", 7.0, "*", "r2", 0.5627, -4.8, "*", 0.6032, 2.1, ""], ["dielectric_electronic", 3124, 0.8574, 0.8359, -2.5, "*", 0.8435, -1.6, "*", 0.8658, 1.0, "", 2.6, "*", "r2", 0.8469, -1.2, "*", 0.8647, 0.8, ""], ["magnetization", 1160, 0.7611, 0.7742, 1.7, "", 0.773, 1.6, "", 0.7983, 4.9, "*", 3.3, "*", "r2", 0.7473, -1.8, "", 0.7964, 4.6, "*"], ["magnetic_moment", 851, 0.698, 0.6538, -6.3, "*", 0.6588, -5.6, "*", 0.7025, 0.7, "", 6.6, "*", "r2", 0.6113, -12.4, "*", 0.716, 2.6, ""], ["magnetic_susceptibility", 58, 0.1712, -0.0773, -145.1, "*", 0.0945, -44.8, "", -0.0094, -105.5, "*", -109.9, "*", "r2", -0.0232, -113.5, "*", -0.0182, -110.6, "*"]];
const COUNTS = {"xfer_vs_single": {"better": 1, "worse": 19, "unresolved": 4, "better (negligible)": 0, "worse (negligible)": 0}, "ftz_vs_single": {"better": 4, "worse": 12, "unresolved": 7, "better (negligible)": 0, "worse (negligible)": 1}, "ftf_vs_single": {"better": 4, "worse": 4, "unresolved": 14, "better (negligible)": 0, "worse (negligible)": 2}, "ftf_vs_xfer": {"better": 19, "worse": 0, "unresolved": 2, "better (negligible)": 3, "worse (negligible)": 0}, "ftf_vs_ftz": {"better": 13, "worse": 2, "unresolved": 7, "better (negligible)": 2, "worse (negligible)": 0}, "ftzu_vs_single": {"better": 1, "worse": 13, "unresolved": 9, "better (negligible)": 0, "worse (negligible)": 1}, "ftfu_vs_single": {"better": 2, "worse": 4, "unresolved": 15, "better (negligible)": 0, "worse (negligible)": 3}, "ftz_vs_ftzu": {"better": 5, "worse": 0, "unresolved": 16, "better (negligible)": 3, "worse (negligible)": 0}};
...
for(const r of ROWS){
  const [task,n,single,xf,xfp,xfm,fz,fzp,fzm,wm,wmp,wmm,wf,wfm,metric,fzu,fzup,fzum,wmu,wmup,wmum]=r;
  const tr=document.createElement("tr");
  tr.innerHTML=`<td>${pretty(task)}${metric==="macro_f1"?" <span style='color:var(--muted);font-size:11px'>(macro-F1)</span>":""}</td><td>${n.toLocaleString()}</td><td>${single.toFixed(4)}</td>
   ...
   <td>${fzu==null?"-":fzu.toFixed(4)}</td><td class="${cls(fzup,fzum)}">${fmtp(fzup,fzum)}</td>
   <td>${wmu==null?"-":wmu.toFixed(4)}</td><td class="${cls(wmup,wmum)}">${fmtp(wmup,wmum)}</td>`;
  tb.appendChild(tr);
}
...
function draw(){
  ...
  try{(function(){
    ...
    const nb=el("text",{x:330,y:200,class:"axis"}); nb.textContent="X never seen · n = 3"; svg.appendChild(nb);

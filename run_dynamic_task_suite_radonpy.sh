...
DEFAULT_CONFIG="${REPO_ROOT}/samples/dynamic_task_suite_config_radonpy.toml"
...
if [[ ! -f "${CONFIG_FILE}" ]]; then
  ...
  echo "Provide a valid path or update samples/dynamic_task_suite_config_radonpy.toml." >&2
  exit 1
fi
